...
macro_rules! generate_tests {
    ($generator:ident) => {
        $generator! { boolean_and }
        $generator! { boolean_not }
        $generator! { boolean_or }
        $generator! { collect_integers_into_vector }
        $generator! { collect_into_vec_of_vecs }
        $generator! { collect_two_vectors_of_integers }
        $generator! { collect_vector_of_rust_native_objects }
        $generator! { collecting_into_vector }
        $generator! { conditional_with_unchanged_native_obj_in_else_branch }
        $generator! { eval_comparisons }
        $generator! { eval_conditional_reduction }
        $generator! { eval_conditional_reduction_with_no_change_in_else_branch }
        $generator! { eval_conditional_reduction_with_no_change_in_if_branch }
        $generator! { eval_div_mul_mod }
        $generator! { eval_fp32_multiplication }
        ...
        $generator! { eval_integer_subtraction }
        $generator! { eval_iterator_chain_collect }
        $generator! { eval_iterator_collect }
        $generator! { eval_iterator_filter_collect }
        $generator! { eval_iterator_filter }
        $generator! { eval_iterator_find_map }
        $generator! { eval_iterator_find_none }
        $generator! { eval_iterator_find }
        $generator! { eval_iterator_first }
        $generator! { eval_iterator_map_collect_native_obj }
        $generator! { eval_iterator_map_collect }
        $generator! { eval_length_zero_reductions }
        $generator! { eval_map_reduce }
        $generator! { eval_native_function_call }
        $generator! { eval_nested_function_call }
        $generator! { eval_nested_integer_expression }
        $generator! { eval_nested_reductions }
        $generator! { eval_nested_reductions_with_enclosed_variables }
        $generator! { eval_nested_reductions_with_native_function_as_last_expression }
        $generator! { eval_nested_reductions_with_native_function }
        $generator! { multiple_functions_in_one_vm }
        $generator! { native_function_call_accepting_native_option }
        $generator! { native_function_call_accepting_prim_option }
        $generator! { other_functions_do_not_impact_performance }
        $generator! { parse_and_eval_native_function_call }
        $generator! { pass_str_reference_to_native_function }
        $generator! { pass_string_object_to_native_function }
        $generator! { reduce_integers_into_constant_value }
        $generator! { reduce_into_vec_of_vecs, ignore="Known failing test" }
        $generator! { reduce_with_extent_none }
        ...
        $generator! { sum_of_integers_in_native_function_returning_value }
...
pub trait Build: Sized {
    ...
    type Error;
    fn build(&mut self, graph: &SymbolicGraph) -> Result<Self::Output, Error>;
}

impl<Func, R, E> Build for Func
where
    Func: FnMut(&SymbolicGraph) -> Result<R, Error>,
    Error: From<E>,
    R: Runtime<Error = E>,
{
    type Output = R;
...
pub fn eval_integer_subtraction(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_integer_multiplication(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_fp32_multiplication(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_nested_integer_expression(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_function_call_with_unused_parameters(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_native_function_call(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_nested_function_call(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn parse_and_eval_native_function_call(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn native_function_call_accepting_prim_option(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn native_function_call_accepting_native_option(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn sum_of_integers_in_vm_function(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
    graph.parse(stringify! {
...
pub fn reduce_integers_into_constant_value(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
    graph.parse(stringify! {
...
pub fn sum_of_integers_in_native_function_returning_value(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn sum_of_integers_in_native_function_mutating_arg(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn collect_integers_into_vector(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn collect_two_vectors_of_integers(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn collect_vector_of_rust_native_objects(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_length_zero_reductions(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_nested_reductions_with_enclosed_variables(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_nested_reductions_with_native_function(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_nested_reductions_with_native_function_as_last_expression(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_conditional_reduction(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_conditional_reduction_with_no_change_in_if_branch(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_conditional_reduction_with_no_change_in_else_branch(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_iterator_find_none(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_iterator_filter_collect(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_iterator_map_collect(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_iterator_chain_collect(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn eval_iterator_map_collect_native_obj(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn reduction_with_last_usage_of_var(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn reduce_into_vec_of_vecs(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn collect_into_vec_of_vecs(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn reduce_with_extent_none(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn reduction_with_numeric_conditional_in_map(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn reduction_with_none_check_in_map(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn pass_string_object_to_native_function(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn pass_str_reference_to_native_function(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn multiple_functions_in_one_vm(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn other_functions_do_not_impact_performance(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
...
pub fn use_same_reduction_function_in_multiple_locations(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn reduction_with_enclosed_variable_from_inlined_function(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn reduction_with_identical_subexpr_in_condition_and_branch(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn use_global_var_from_multiple_public_functions(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    let mut graph = SymbolicGraph::new();
...
pub fn conditional_with_unchanged_native_obj_in_else_branch(
    mut builder: impl Build<Error: Into<Error>>,
) -> Result<(), Error> {
    #[derive(RustNativeObject)]
